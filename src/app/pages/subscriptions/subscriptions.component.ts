...
export class SubscriptionsComponent implements OnInit, OnDestroy {
    ...
    this.subscriptionService.subscribe(this.userId, plan.id)
      .subscribe({
        ...
        error: (err: HttpErrorResponse) => {
          const msg = err.error?.message || err.error?.error || err.message || 'Subscription failed';
          console.error('Subscribe error', err.status, err.error);
  ...
  submitRecommendation(): void {
    ...
    const payload: RecommendationPayload = {
      ...
      avg_ticket_price: rawValue.avg_ticket_price,
      group_size: rawValue.group_size,
      distance_km: rawValue.distance_km,
      app_sessions_per_week: rawValue.app_sessions_per_week,
      last_booking_days_ago: rawValue.last_booking_days_ago,
      promo_sensitivity: rawValue.promo_sensitivity,
      satisfaction_score: rawValue.satisfaction_score,
      preferred_genre: rawValue.preferred_genre,
      watch_time_pref: rawValue.watch_time_pref,
      has_streaming_subscription: rawValue.has_streaming_subscription
    };
