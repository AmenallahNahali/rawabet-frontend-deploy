...
export class AdminNotificationsComponent implements OnInit, OnDestroy {
  ...
  ngOnInit() {
    ...
    // Track WebSocket connection status (set by NotificationService via admin-layout)
    this.wsSub = this.notificationService.connected$.subscribe((connected) => {
      this.isLive = connected;
      this.cd.markForCheck();
    });

    // Auto-refresh the list when a broadcast notification is delivered in real-time
    this.wsSub.add(
